...
def get_model(point_cloud, is_training, batch_size, bn_decay=None):
  ...
  net = tf_util.conv2d(tf.concat([net1, net2, net3, net4], axis=-1), 128, [1, 1],
                       padding='VALID', stride=[1,1],
                       bn=True, is_training=is_training,
  ...
  #net = tf_util.dropout(net, keep_prob=0.5, is_training=is_training,
  #                      scope='dp2')
  #net = tf_util.fully_connected(net, 128, activation_fn=None, scope='fc3')
